...
var portfolioRepository = data_source_1.connectionSource.getRepository(model_1.PortfolioDetails);
var trackRepository = data_source_1.connectionSource.getRepository(model_1.UserTrack);
...
var getUserById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                portfolio = _a.sent();
                res.status(200).json({ user: user, portfolio: portfolio });
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
